...
const AddModal = (props) => {
  let modalTitle = "Add new RFP TYPE ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertRfpType';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "RFP Type has been added", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
...
const EditModal = (props) => {
  let modalTitle = "Update RFP TYPE ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateRfpType';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "RFP Type has been updated", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
  ...
  useEffect(() => {
    ...
    if(props.open==true){
      ...
      setRfpType(filtered[0].rfp_type);
...
const TableList = () => {
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getRfpTypeSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="simple table">
          <TableHead sx={{ backgroundColor: tableHeaderColor }}>
            ...
            <TableRow>
              ...
              <TableCell component="th">RFP Type</TableCell>
            ...
            {(rowsPerPage > 0
              ...
              : dataArr
                ...
                >
                  ...
                  <TableCell scope="row">{row.rfp_type}</TableCell>
