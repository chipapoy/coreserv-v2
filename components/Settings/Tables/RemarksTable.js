...
const AddModal = (props) => {
  let modalTitle = "Add new REMARKS ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertRemarks';
...
const EditModal = (props) => {
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateRemarks';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Remarks has been updated", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
...
const TableList = () => {
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getRemarksSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
            ...
            {(rowsPerPage > 0
              ...
              : dataArr
                ...
                >
                  ...
                  <TableCell scope="row">{row.remarks}</TableCell>
