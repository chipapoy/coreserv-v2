...
const AddModal = (props) => {
  let modalTitle = "Add new DISPATCH TYPE ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertDispType';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Dispatch Type has been added", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
...
const EditModal = (props) => {
  let modalTitle = "Update DISPATCH TYPE ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateDispType';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Dispatch Type has been updated", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
  ...
  useEffect(() => {
    ...
    if(props.open==true){
      ...
      setDispType(filtered[0].disp_type);
...
const TableList = () => {
  ...
  let tableTitle = "DISPATCH TYPE List";
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getDispTypeSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="simple table">
          <TableHead sx={{ backgroundColor: tableHeaderColor }}>
            ...
            <TableRow>
              ...
              <TableCell component="th">Dispatch Type</TableCell>
            ...
            {(rowsPerPage > 0
              ...
              : dataArr
                ...
                >
                  ...
                  <TableCell scope="row">{row.disp_type}</TableCell>
