...
const AddModal = (props) => {
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertCity';
...
const EditModal = (props) => {
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateCity';
...
const TableList = () => {
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getCitySettings', {cancelToken:cancelToken.token})
    .then( (result) => {
            ...
            {(rowsPerPage > 0
              ...
              : dataArr
                ...
                >
                  ...
                  <TableCell scope="row">{row.city}</TableCell>
