...
const AddModal = (props) => {
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertCrew';
...
const EditModal = (props) => {
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateCrew';
  ...
  useEffect(() => {
    ...
    if(props.open==true){
      ...
      setTeamCode(filtered[0].team_code);
      setTech(filtered[0].technician);
...
const TableList = () => {
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getCrewSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="simple table">
          <TableHead sx={{ backgroundColor: tableHeaderColor }}>
            ...
            <TableRow>
              ...
              <TableCell component="th">Team Code</TableCell>
              <TableCell component="th">Technician</TableCell>
            ...
            {(rowsPerPage > 0
              ...
              : dataArr
                ...
                >
                  ...
                  <TableCell scope="row">{row.team_code}</TableCell>
                  <TableCell scope="row">{row.technician}</TableCell>
