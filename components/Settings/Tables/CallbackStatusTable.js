...
const AddModal = (props) => {
  let modalTitle = "Add new CALLBACK STATUS ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertCallbackStatus';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Callback Status has been added", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
...
const EditModal = (props) => {
  let modalTitle = "Update CALLBACK STATUS ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateCallbackStatus';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Callback Status has been updated", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
  ...
  useEffect(() => {
    ...
    if(props.open==true){
      ...
      setCallbackStatus(filtered[0].callback_status);
...
const TableList = () => {
  ...
  let tableTitle = "CALLBACK STATUS List";
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getCallbackStatusSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="simple table">
          <TableHead sx={{ backgroundColor: tableHeaderColor }}>
            ...
            <TableRow>
              ...
              <TableCell component="th">Callback Status</TableCell>
            ...
            {(rowsPerPage > 0
              ...
              : dataArr
                ...
                >
                  ...
                  <TableCell scope="row">{row.callback_status}</TableCell>
