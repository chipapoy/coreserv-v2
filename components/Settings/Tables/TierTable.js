...
const AddModal = (props) => {
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertTier';
...
const EditModal = (props) => {
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateTier';
...
const TableList = () => {
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getTierSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="simple table">
          <TableHead sx={{ backgroundColor: tableHeaderColor }}>
            ...
            <TableRow>
              ...
              <TableCell component="th">Tier</TableCell>
            ...
            {(rowsPerPage > 0
              ...
              : dataArr
                ...
                >
                  ...
                  <TableCell scope="row">{row.tier}</TableCell>
