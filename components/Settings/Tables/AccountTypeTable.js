...
const AddModal = (props) => {
  let modalTitle = "Add new ACCOUNT TYPE ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertAccountType';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Account Type has been added", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
...
const EditModal = (props) => {
  let modalTitle = "Update ACCOUNT TYPE ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateAccountType';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Account Type has been updated", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
  ...
  useEffect(() => {
    ...
    if(props.open==true){
      ...
      setAccountType(filtered[0].account_type);
...
const TableList = () => {
  ...
  let tableTitle = "ACCOUNT TYPE List";
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getAccountTypeSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
            ...
            {(rowsPerPage > 0
              ...
              : dataArr
                ...
                >
                  ...
                  <TableCell scope="row">{row.account_type}</TableCell>
