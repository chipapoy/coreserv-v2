...
const AddModal = (props) => {
  let modalTitle = "Add new ACCOUNT ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertAccount';
...
const EditModal = (props) => {
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateAccount';
...
const TableList = () => {
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getAccountSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
