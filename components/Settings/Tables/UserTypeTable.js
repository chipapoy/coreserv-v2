...
const AddModal = (props) => {
  let modalTitle = "Add new USER TYPE ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertUserType';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "User Type has been added", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
...
const EditModal = (props) => {
  let modalTitle = "Update USER TYPE ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "User Type has been updated", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
...
const TableList = () => {
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getUserTypeSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
