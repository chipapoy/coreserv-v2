...
const AddModal = (props) => {
  let modalTitle = "Add new ACTIVITY STATUS ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertStatus';
...
const EditModal = (props) => {
  let modalTitle = "Update ACTIVITY STATUS ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateStatus';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Status has been updated", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
...
const TableList = () => {
  ...
  let tableTitle = "ACTIVITY STATUS List";
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getStatusSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
