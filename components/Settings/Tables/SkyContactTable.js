...
const AddModal = (props) => {
  let modalTitle = "Add new SKY CONTACT ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/insert/insertSkyContact';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Sky Contact has been added", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
...
const EditModal = (props) => {
  let modalTitle = "Update SKY CONTACT ";
  const style = {
    position: 'absolute',
    top: '35%',
    left: '50%',
  ...
  const submitData = e => {
    ...
    const url = '/api/maintenance_request/update/updateSkyContact';
    ...
    .then( res => {
      ...
      setTimeout(() => {
        toast.update(notifId, {
          render: "Sky Contact has been updated", 
          type: 'success',
          isLoading: false,
          delay:undefined,
          position: "top-right",
  ...
  useEffect(() => {
    ...
    if(props.open==true){
      ...
      setContactPerson(filtered[0].contact_person);
      setContactNumber(filtered[0].contact_number);
      setEmailAddress(filtered[0].email_add);
...
const TableList = () => {
  ...
  let tableTitle = "SKY CONTACT List";
  ...
  const getDataArr = async () => {
    ...
    axios.get('/api/maintenance_request/getSkyContactSettings', {cancelToken:cancelToken.token})
    .then( (result) => {
            ...
            {(rowsPerPage > 0
              ...
              : dataArr
                ...
                >
                  ...
                  <TableCell scope="row">{row.contact_person}</TableCell>
                  <TableCell scope="row">{row.contact_number}</TableCell>
                  <TableCell scope="row">{row.email_add}</TableCell>
